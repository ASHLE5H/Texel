...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-center mx-auto mt-10 text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px]'>Turn text to <span className='text-blue-600'
        initial={{opacity:0 }}
        animate={{opacity:1}}
      ...
      >
        {
         Array(6).fill('').map((item, index) => (                                               //creates an empty array ['', '', '', '', '', ''] and loops over evry index
      ...
      >Generated images from Texel</motion.p>
    </motion.div>
  )
}
